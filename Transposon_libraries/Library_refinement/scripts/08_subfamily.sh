...
# Copy database to avoid disrupting parallel runs
mkdir tmp
cp /mnt/scratchb/ghlab/sus/resources/bergmanlab-transposons/transposons/current/blastdb/transposons.fa tmp

conda activate full_blast
full_blast -q ../fasta/03_subset_reduced.fa -s tmp/transposons.fa -p megablast -o 80-80-80 -i 80 -qc 80 -l 80 -t 1
full_blast -q ../fasta/03_subset_reduced.fa -s tmp/transposons.fa -p megablast -o 90-80-90 -i 90 -qc 90 -l 80 -t 1
full_blast -q ../fasta/03_subset_reduced.fa -s tmp/transposons.fa -p megablast -o 95-80-98 -i 95 -qc 98 -l 80 -t 1
conda deactivate
